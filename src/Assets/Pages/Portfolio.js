        ...
        <Container>
          <Row>
            ...
            <Col md={6}>
              ...
              <p className="portherodesc addpaddingherodesc">
                Stay on top of your crypto portfolio with Shootfolio. Our
                easy-to-use platform lets you track your investments, view
        ...
        <Container>
          <Row>
            <Col md={3} className="mblmargtop">
              <Portfoliofile
                image={images.portimg}
                name="Asset Name"
                feature="Feature 1.Feature 1.Feature 1"
                pricehead="Current Price"
                price="59WQ.568"
                valuehead="Total Value"
                value="KD6721"
              />
            </Col>
            <Col md={3} className="mblmargtop">
